...
{
    internal class DoubleActionRevolver : Weapon
    {
        public override bool SaveFileWeapon => true;

        public override uint WeaponHash => (uint)GTA.WeaponHash.DoubleActionRevolver;

        public override int Price => 30000;

        public override string Name => "Double-Action Revolver";
