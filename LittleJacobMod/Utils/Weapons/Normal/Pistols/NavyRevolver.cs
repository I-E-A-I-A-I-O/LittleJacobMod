...
{
    internal class NavyRevolver : Weapon
    {
        public override bool SaveFileWeapon => true;

        public override uint WeaponHash => (uint)GTA.WeaponHash.NavyRevolver;

        public override int Price => 60000;

        public override string Name => "Navy Revolver";
