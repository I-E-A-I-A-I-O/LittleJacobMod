...
{
    internal class CompactGrenadeLauncher : Weapon
    {
        public override bool SaveFileWeapon => true;

        public override uint WeaponHash => (uint)GTA.WeaponHash.CompactGrenadeLauncher;

        public override int Price => 40000;

        public override string Name => "Compact Grenade Launcher";
