...
namespace LittleJacobMod.Utils.Weapons
{
    internal class Gusenberg : Weapon
    {
        ...
        public override uint WeaponHash => (uint)GTA.WeaponHash.Gusenberg;
        ...
        {
            { "Normal - $199", (uint)WeaponComponentHash.GusenbergClip01 },
            { "Extended - $7000", (uint)WeaponComponentHash.GusenbergClip02 },
        };
