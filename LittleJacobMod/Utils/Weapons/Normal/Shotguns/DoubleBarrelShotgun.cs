...
{
    internal class DoubleBarrelShotgun : Weapon
    {
        public override bool SaveFileWeapon => true;

        public override uint WeaponHash => (uint)GTA.WeaponHash.DoubleBarrelShotgun;

        public override int Price => 10000;

        public override string Name => "Double Barrel Shotgun";
